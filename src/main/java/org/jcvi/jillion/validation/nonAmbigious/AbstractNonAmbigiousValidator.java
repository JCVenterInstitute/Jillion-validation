...
public abstract class AbstractNonAmbigiousValidator<T>  implements ConstraintValidator<NonAmbiguous, T> {
    ...
    @Override
    public void initialize(NonAmbiguous constraintAnnotation) {
